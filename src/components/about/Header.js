          ...
          <div className="mx-auto max-w-full xl:mx-12 xl:pt-32 xl:pb-40 lg:pt-40 lg:pb-40 pt-24 pb-12 ">
            <div>
              <div>
                ...
                <p className="mt-20 pt-2 text-2xl leading-10 text-black max-w-3xl">
                Nuestra empresa está formada por un equipo diverso de profesionales apasionados por el desarrollo de software. Desde ingenieros altamente calificados hasta diseñadores creativos y expertos en experiencia del usuario, cada miembro de nuestro equipo contribuye a la creación de soluciones tecnológicas de primer nivel.
                </p>
